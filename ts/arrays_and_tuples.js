...
let numbers = [1, 2, 3, 4, 5]; // 숫자형 배열 정의
let strings = ["하나", "둘", "셋"]; // 문자열 배열 정의
// 배열의 타입 제한과 다차원 배열
...
let myAddress = ["서울특별시", 12345, "대한민국"];
...
function getEmployeesAboveAge(employees, age) {
