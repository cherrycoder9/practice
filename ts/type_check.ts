...
function getUserNameById(userId: number | null): string {
...
console.log(calculateTotal(shoppingCart)); // 6000
...
// 엄격 모드에서 객체나 속성이 존재하지 않을 경우 안전하게 접근할 수 있도록 함
interface UserTC {
    id: number;
    name: string;
    address?: {
...
function getUserCity(user: UserTC): string {
...
// 함수 호출
const usertc1: UserTC = { id: 1, name: "머스크", address: { street: "안남로", city: "인천" } };
const usertc2: UserTC = { id: 2, name: "하사비스" }; // 주소 없음
